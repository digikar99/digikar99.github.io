...
#+html: <nav>
[[file:index.html][Home]] | [[file:ai-cogsci.html][AI and CogSci]] | [[file:common-lisp-and-emacs.html][Common Lisp and Emacs]] | [[file:academic-history.html][Academic History]] | *MISCELLANEOUS*
#+html: </nav>
...
- [[https://moonli-lang.github.io/][Moonli]]
...
:PROPERTIES:
:CUSTOM_ID: free-and-open-source
:END:

- [[https://www.lyx.org/][Lyx - The Document Processor]] - A GUI frontend and a nicer layer over Latex
- [[https://nostr.com/][Nostr]] - Notes and Other Stuff Transmitted by Relays
  - [[https://nostr.how/en/why-nostr][Why Nostr]]
- [[https://vigneshwarshankar.com/blog/why-you-should-write-in-markdown/][Why you should write in markdown - Vigneshwar's blog]]
- [[https://rpdillon.net/why-doesnt-emacs-org-mode-just-use-markdown-2021.html][Why doesn't Emacs' Org Mode just use Markdown? (2021)]]
...
These days, I have moved to a [[https://digikar99.github.io/microblog/][static blog]] as well as [[https://primal.net/p/npub14f2lywp9dyrnl3exttjly0y3alqsuykeqveqz26mtwg6pu5e2s9scmfr5q][Nostr]]. Earlier, I used to write on a [[http://human9being9.wordpress.com/][wordpress]] blog. Some articles of potential general interest from wordpress blog include:
