...
#+html: <nav>
[[file:index.html][Home]] | *AI AND COGSCI* | [[file:common-lisp-and-emacs.html][Common Lisp and Emacs]] | [[file:academic-history.html][Academic History]] | [[file:miscellaneous.html][Miscellaneous]]
#+html: </nav>
...
:CONTENTS:
- [[#multiple-object-tracking-without-correspondence][Multiple Object Tracking without Correspondence]]
- [[#10-years-speculative-computer-science-cognition-as-the-tracking-of-individuals][[10 years, speculative, computer science] Cognition as the Tracking of Individuals]]
- [[#4-years-speculative-cognitive-science-causality-discovering-causal-variables][[4 years, speculative, cognitive science] Causality: Discovering Causal Variables]]
- [[#unknown-years-speculative-cognitive-science-perspective-taking-symbolic-communication-and-social-cognition][[unknown years, speculative, cognitive science] Perspective Taking, Symbolic Communication and Social Cognition]]
:END:

** Multiple Object Tracking without Correspondence
:PROPERTIES:
:CUSTOM_ID: multiple-object-tracking-without-correspondence
:END:
...
:PROPERTIES:
:CUSTOM_ID: 4-years-speculative-cognitive-science-causality-discovering-causal-variables
:END:
...
In fact, causal models have the potential to address issues related to transfer learning and out-of-distribution generalization that have been picking up pace in the machine learning community over the last decade. (See [[citet:&Scholkopf2021Causal]].) However, most research on causality either involves the causal models or at least the variables being given apriori. It is unclear how such variables may be discovered from high dimensional data. It should certainly be possible, since humans as well as non-human animals seem to be able to do it quite well.
...
:PROPERTIES:
:CUSTOM_ID: unknown-years-speculative-cognitive-science-perspective-taking-symbolic-communication-and-social-cognition
:END:
