...
#+html: <nav>
[[file:index.html][Home]] | [[file:ai-cogsci.html][AI and CogSci]] | *COMMON LISP AND EMACS* | [[file:academic-history.html][Academic History]] | [[file:miscellaneous.html][Miscellaneous]]
#+html: </nav>
...
- [[#major-common-lisp-related-projects][Major Common Lisp-related Projects]]
  - [[#1-moonli-transpiler-from-pythonjulia-like-algol-syntax-to-common-lisp][1. Moonli: Transpiler from Python/Julia-like algol-syntax to Common Lisp]]
  - [[#2-python-libraries-for-common-lisp][2. Python libraries for Common Lisp]]
  - [[#3-fast-math-library-for-common-lisp][3. Fast math library for Common Lisp]]
  - [[#4-peltadot-peltadot-extends-lisps-types-and-dispatches-over-them][4. PELTADOT: PELTADOT Extends Lisp's Types And Dispatches Over Them]]
...
My major Lisp projects can be divided into four broad themes.

** 1. Moonli: Transpiler from Python/Julia-like /algol-syntax/ to Common Lisp
:PROPERTIES:
:CUSTOM_ID: 1-moonli-transpiler-from-pythonjulia-like-algol-syntax-to-common-lisp
:END:

Can we get the power of Common Lisp in a syntax that is more familiar to most people? [[https://moonli-lang.github.io/][Moonli is an attempt at this.]]

The simple idea is to transpile
...
Read more here: https://moonli-lang.github.io/docs/

** 2. Python libraries for Common Lisp
:PROPERTIES:
:CUSTOM_ID: 2-python-libraries-for-common-lisp
:END:
...
** 3. Fast math library for Common Lisp
:PROPERTIES:
:CUSTOM_ID: 3-fast-math-library-for-common-lisp
:END:
...
** 4. PELTADOT: PELTADOT Extends Lisp's Types And Dispatches Over Them
:PROPERTIES:
:CUSTOM_ID: 4-peltadot-peltadot-extends-lisps-types-and-dispatches-over-them
:END:
